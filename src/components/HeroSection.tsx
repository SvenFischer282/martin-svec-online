          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground leading-tight">
                <span className="italic text-foreground/80">Grafický</span> dizajnér
              </h2>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-lg text-foreground">Moderný a kreatívny prístup</p>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle2 className="h-6 w-6 text-primary flex-shrink-0" />
                <p className="text-lg text-foreground">Dizajn pre weby, branding a tlač</p>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle2 className="h-6 w-6 text-primary flex-shrink-0" />
              ...
              <div className="absolute bottom-8 right-8 bg-background rounded-2xl shadow-2xl p-6 transform hover:scale-105 transition-transform">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="text-xs text-muted-foreground font-medium">Kreatívne</p>
                    <p className="text-sm font-bold text-foreground">Riešenia</p>
                  </div>
                </div>
              </div>
            </div>
