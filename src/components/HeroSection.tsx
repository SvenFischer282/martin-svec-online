          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground leading-tight">
                <span className="italic text-foreground/80">Špecialista</span> na Google reklamu
              </h2>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-lg text-foreground">Certifikovaný Google a Shoptet Partner</p>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle2 className="h-6 w-6 text-primary flex-shrink-0" />
                <p className="text-lg text-foreground">Získajte viac zákazníkov ešte dnes</p>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle2 className="h-6 w-6 text-primary flex-shrink-0" />
                <p className="text-lg text-foreground">Nastavenie kampaní za 24 hodín</p>
              </div>
            </div>
          ...
          <div className="relative lg:pl-12">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-primary/90 to-primary rounded-[40px] overflow-hidden">
                <img 
                  src={heroImage} 
                  alt="Martin Švec - Špecialista na Google reklamu" 
